...
def crack_hash(hash, wordlist=None, hash_type='md5', min_length=0, max_length=0,
    ...
    if wordlist:
        ...
        print(
            f'[*] Cracking hash {hash} using {hash_type} with generated passwords of lengths from {min_length} to {max_length}. Total combinations: {total_combinations}.')
...
if __name__ == '__main__':
    ...
    cracked_password = crack_hash(args.hash, args.wordlist, args.hash_type, args.min_length, args.max_length,
                                  args.characters, args.max_workers)
